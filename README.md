...
| 板块 | 内容 | 数据来源 |
|---|---|---|
| 📋 生产日报 | 在修/封存飞机、生产情况表、每日纪要、进出场信息 | IMA 知识库《2026年贝迪克凌云生产日报.xlsx》 |
...
- 页面自动刷新：每 10 分钟
- 后端定时更新（OpenClaw cron，每 2 小时）：IMA 下载最新日报 → 解析 → 百度资讯更新新闻 → 更新英语 → 合并 → 推送 GitHub
