...
| 板块 | 内容 | 数据来源 |
|---|---|---|
| 📋 生产日报 | 在修/封存飞机、生产情况表、每日纪要、进出场信息 | 本地文件 D:\ai\存档\2026年贝迪克凌云生产日报.xlsx1.xlsx（文件更新即自动更新） |
...
- 页面自动刷新：每 10 分钟
- 后端定时更新（OpenClaw cron，每 2 小时）：检测本地日报文件变化（MD5）→ 解析 → 百度资讯更新新闻 → 更新英语 → 合并 → 推送 GitHub
- 数据源变更记录：2026-08-10 由 ima 知识库 API 改为本地文件 D:\ai\存档\2026年贝迪克凌云生产日报.xlsx1.xlsx
